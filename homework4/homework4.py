...
SORT_TYPE_LENGTH = 3
func_str = ["bubble sort", "selection sort", "exchange sort"]
sort_type_str = ["random", "sorted", "reversed"]
func = [bubblesort.bubble_sort,
        selectionsort.selection_sort, exchangesort.exchange_sort]
RANDOM_TYPE = 1
SORTED_TYPE = 2
REVERSED_TYPE = 3
...
if __name__ == "__main__":
    ...
    select = int(
        input("""
        ======Bar Graph======
        1. bubble sort sensitivity
        2. exchange sort sensitivity
        3. shaker sort sensitivity
        4. Compare 1~3
        =======Line Graph======
        5. random array
        6. sorted array
